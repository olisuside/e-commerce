...
<?php 
    ...
    if(isset($_POST["update"])){
        $kode = $_POST['idkategori'];
        $q1 = mysqli_query($conn, "update kategori where idkategori='$kode'");
        if($q1){
...
<head>
    ...
    <title>Kelola Kategori - BLONGSTORE</title>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td class="invert">
                                                    <form method="post">
													<a class="btn btn-info" data-toggle="modal" data-target="#kategori<?php echo $id ?>"><div class="icon"><i class="fa fa-cog"></i></div></a>
												...
												<!-- modal input -->
														<div id="kategori<?php echo $id ;?>" class="modal fade">
															<div class="modal-dialog modal-lg">
																<div class="modal-content">
																	<div class="modal-header">
																		<h4 class="modal-title"><?php echo $p['namakategori'] ?>
																	</div>
																	<div class="modal-body">
																		<form method="post">
																			<div class="form-group">
																				<label>Nama Kategori</label>
																				<input name="namakategori" type="text" class="form-control" value="<?php echo $p['namakategori'] ?>">
																			</div>
											...
											if(isset($_POST["delete"])){
													$barangid = $_POST['idkategori'];
													$hapusin = mysqli_query($conn,"DELETE from kategori where idkategori='$barangid'");
													if($hapusin){
												...
												if(isset($_POST["updateinfo"])){
													...
													$updatedata = mysqli_query($conn,"UPDATE kategori SET namakategori='$namakategori' where idkategori='$idkategori'");
													if($updatedata){
													echo " <div class='alert alert-success' align='center'>
