<?php 
	...
	if(isset($_POST["addproduct"])) {
		...
		$path = "../produk/".$namaproduk.'-'.$rand.'.'.$ext;
		$pathdb = "produk/".$namaproduk.'-'.$rand.'.'.$ext;
...
<body>
    ...
    <div class="page-container">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<td><button data-toggle="modal" data-target="#edit<?=$idb;?>" class="btn btn-warning"><div class="icon"><i class="fa fa-cog"></i></div></button> <button data-toggle="modal" data-target="#del<?=$idb;?>" class="btn btn-danger"><div class="icon"><i class="fa fa-trash"></i></div></button></td>	
												</tr>		
                ...
                <div class="modal-dialog">
                    ...
                    <form action="produk.php" method="post" enctype="multipart/form-data">
                      <!-- Modal Header -->
                        ...
                        <h4 class="modal-title">Edit Barang <?php echo $p['namaproduk']?> - <?php echo $p['namakategori']?></h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                         ...
                         <div class="modal-body">
								...
								<div class="form-group">
									...
									<input name="namaproduk" type="text" class="form-control" value="<?php echo $p['namaproduk'] ?>" required autofocus>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input name="deskripsi" type="text" class="form-control" value="<?php echo $p['deskripsi'] ?>" required>
								</div>
								<div class="form-group">
									<label>Rating (1-5)</label>
									<input name="rate" type="number" class="form-control" value="<?php echo $p['rate'] ?>" min="1" max="5" required >
								</div>
								<div class="form-group">
									<label>Harga Sebelum Diskon</label>
									<input name="hargabefore" type="number" class="form-control" value="<?php echo $p['hargabefore'] ?>">
								</div>
								<div class="form-group">
									<label>Harga Setelah Diskon</label>
									<input name="hargaafter" type="number" class="form-control" value="<?php echo $p['hargaafter'] ?>">
								</div>
		...
		$updatedata = mysqli_query($conn,"UPDATE produk SET namaproduk='$namaproduk', idkategori='$idkategori', deskripsi='$deskripsi', rate='$rate', hargabefore='$hargabefore', hargaafter='$hargaafter' where produk.idproduk='$idproduk'");
	...
	if(isset($_POST['hapus'])){
		...
		if ($delete){
			...
			echo " <div class='alert alert-success' align='center'>
			Data kategori akan dihapus dalam 2 detik.
			</div>
			<meta http-equiv='refresh' content='2; url= produk.php'/>  ";
		} else { echo "<div class='alert alert-warning' align='center'>
