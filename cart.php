...
<html>
<head>
<title>BLONGSTORE - Keranjang Saya</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="BLONGSTORE, Richard's Lab" />
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">BLONGSTORE</a></h1>
			</div>
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert">
						<form method="post">							
							<input type="hidden" name="idcart" value="<?php echo $id ?>" \>
					...
					<?php 
											...
											if(isset($_POST["delete"])){
													$uid = $_SESSION['id'];
													$hapusin = mysqli_query($conn,"DELETE from cart where userid='$uid' and status='Cart'");
													if($hapusin){
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i> Jl. Lawu No.420, Cangakan Timur, Cangakan, Kec. Karanganyar, Kabupaten Karanganyar, Jawa Tengah 57712</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>blongstore@gmail.com</li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(+6281) 2222 333</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2021 BlongStore. All rights reserved</p>
			</div>
		</div>
